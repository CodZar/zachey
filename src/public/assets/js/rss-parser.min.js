    ...
    function (t, e, r) {
      ...
      ;(s.prototype.parse = function (t, e, r) {
        ...
        if (!y[E] && (S || (E && !b[E]))) {
          ...
          if (!N)
            for (
              var L = this.hostname.split(/\./), k = ((C = 0), L.length);
              C < k;
              C++
            ) {
              var P = L[C]
              if (P && !P.match(d)) {
                for (var D = '', I = 0, q = P.length; I < q; I++)
                  P.charCodeAt(I) > 127 ? (D += 'x') : (D += P[I])
                if (!D.match(d)) {
                  var M = L.slice(0, C),
                    U = L.slice(C + 1),
                    B = P.match(m)
          ...
          this.hostname.length > 255
            ...
            N || (this.hostname = i.toASCII(this.hostname))
        ...
        (s.prototype.resolveObject = function (t) {
          ...
          S &&
            ((r.hostname = r.host = N ? '' : _.length ? _.shift() : ''),
            (O = !!(r.host && r.host.indexOf('@') > 0) && r.host.split('@')) &&
              ((r.auth = O.shift()), (r.host = r.hostname = O.shift())))
          return (
            (T = T || (r.host && _.length)) && !N && _.unshift(''),
            _.length
              ? (r.pathname = _.join('/'))
        ...
        ;(v.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? L(this) : _(this),
              null
            )
          ...
          return (
            ...
            null === (n = t > 0 ? N(t, e) : null)
              ...
              : (e.length -= t),
            0 === e.length &&
              (e.ended || (e.needReadable = !0), r !== t && e.ended && L(this)),
        ...
        p = (function () {
          function t() {
            ...
            i(this, t),
              ...
              (this.options = e),
              (this.xmlParser = new u.Parser(this.options.xml2js))
          }
          var e, r, n
          return (
            (e = t),
            (r = [
                      ...
                      o(a, function (o) {
                        if (
                          ...
                          if (n === r.options.maxRedirects)
                            return s(new Error('Too many redirects'))
                          var a = c.resolve(t, o.headers.location)
                          return r.parseURL(a, null, n + 1).then(e, s)
                        }
                        if (o.statusCode >= 300)
                          return s(new Error('Status code ' + o.statusCode))
                        var u = h.getEncodingFromContentType(
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this,
                    r = { items: [] }
                  if (
                    (h.copyFromXML(t.feed, r, this.options.customFields.feed),
                    t.feed.link &&
                      ((r.link = h.getLink(t.feed.link, 'alternate', 0)),
                      (r.feedUrl = h.getLink(t.feed.link, 'self', 1))),
                    t.feed.title)
                  ) {
              ...
              },
              {
                ...
                value: function (t) {
                  var e = {}
                  if (
                    (h.copyFromXML(t, e, this.options.customFields.item),
                    t.title)
                  ) {
                    var r = t.title[0] || ''
                  ...
                  return (
                    t.link &&
                      t.link.length &&
                      (e.link = h.getLink(t.link, 'alternate', 0)),
                    t.published &&
                      t.published.length &&
                    ...
                    t.content &&
                      t.content.length &&
                      ((e.content = h.getContent(t.content[0])),
                      (e.contentSnippet = h.getSnippet(e.content))),
                    t.summary &&
                      t.summary.length &&
                      (e.summary = h.getContent(t.summary[0])),
                    t.id && (e.id = t.id[0]),
                    this.setISODate(e),
                    e
                  )
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    t.description &&
                      ((r.content = h.getContent(t.description[0])),
                      (r.contentSnippet = h.getSnippet(r.content))),
                    t.guid &&
                      ((r.guid = t.guid[0]), r.guid._ && (r.guid = r.guid._)),
                    t.$ &&
                      t.$['rdf:about'] &&
                      (r['rdf:about'] = t.$['rdf:about']),
                ...
                value: function (t, e) {
                  ...
                  if (((t.itunes = {}), e['itunes:owner'])) {
                    ...
                    e['itunes:owner'][0]['itunes:name'] &&
                      (i.name = e['itunes:owner'][0]['itunes:name'][0]),
                      e['itunes:owner'][0]['itunes:email'] &&
                        (i.email = e['itunes:owner'][0]['itunes:email'][0]),
                      (t.itunes.owner = i)
                  }
                  if (
                    (e['itunes:image'] &&
                  ...
                  h.copyFromXML(e, t.itunes, l.podcastFeed),
                    n.forEach(function (e, r) {
                      var n = t.items[r]
                      ;(n.itunes = {}),
                        h.copyFromXML(e, n.itunes, l.podcastItem)
        ...
        /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (s) {
          ...
          function x(t) {
            ...
            for (i = r > 0 ? r + 1 : 0; i < d; ) {
              ...
              ;(b = A(m - o, (e = p.length + 1), 0 == o)),
                y(m / e) > f - g && v('overflow'),
                (g += y(m / e)),
                (m %= e),
                p.splice(m++, 0, g)
            }
                    ...
                    if ('object' !== n(e))
                      ...
                      for (d in e)
                        if (u.call(e, d))
                          if (((l = e[d]), d === r)) {
                            if ('object' === n(l))
                              for (i in l) (m = l[i]), (t = t.att(i, m))
                          } else if (d === o)
                            t = f.options.cdata && s(l) ? t.raw(a(l)) : t.txt(l)
                  ...
                  (this.saxParser.onclosetag = (function (t) {
                    return function () {
                      ...
                      if (
                        ...
                        s(h) &&
                          (h =
                            'function' == typeof t.options.emptyTag
                              ? t.options.emptyTag()
                              : '' !== t.options.emptyTag
                              ? t.options.emptyTag
                              : o),
                        ...
                        if (t.options.preserveChildrenOrder) {
                          if (m) {
                            for (u in ((m[t.options.childkey] =
                              m[t.options.childkey] || []),
                          ...
                          (c = Object.create(null)),
                            ...
                            (h = c)
                      return i.length > 0
                        ? t.assignOrPush(m, l, h)
                        : (t.options.explicitRoot &&
                            ((d = h), ((h = Object.create(null))[l] = d)),
                          (t.resultObject = h),
                          (t.saxParser.ended = !0),
                          t.emit('end', t.resultObject))
                    }
                      ...
                      b(f, i)
                        ...
                        : (k(this),
                          '>' === i
                            ...
                            : (m(i) || L(this, 'Invalid character in tag name'),
                              (this.state = _.ATTRIB)))
                      continue
                      ...
                      if (this.tagName)
                        '>' === i
                          ...
                          ? ((this.script += '</' + this.tagName),
                            (this.tagName = ''),
                            (this.state = _.SCRIPT))
                          : (m(i) || L(this, 'Invalid tagname in closing tag'),
            ...
            if (t.opt.xmlns) {
              ...
              for (var o = 0, s = t.attribList.length; o < s; o++) {
                ...
                h &&
                  'xmlns' !== h &&
                  !p &&
                  (L(t, 'Unbound namespace prefix: ' + JSON.stringify(h)),
                  (d.uri = h)),
